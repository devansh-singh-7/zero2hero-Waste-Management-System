...
function AnimatedGlobe() {
  ...
  return (
    <div
      className={`relative w-32 h-32 mx-auto mb-8 cursor-pointer transition-all duration-500 ${clicked ? 'animate-bounce scale-110' : 'hover:scale-105'
        }`}
      onClick={handleClick}
    >
      ...
      <Leaf className={`absolute inset-0 m-auto h-16 w-16 text-green-600 animate-pulse transition-all duration-500 ${clicked ? 'text-yellow-400 scale-125 rotate-180 animate-wiggle' : ''
        }`} />
